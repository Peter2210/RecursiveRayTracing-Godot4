...
public class RayTracingManager : MonoBehaviour
{
	...
	void SetShaderParams()
	{
        ...
        Debug.Log("GroundColour: " + environmentSettings.groundColour.ToString() +
            "\nSkyColourHorizon: " + environmentSettings.skyColourHorizon.ToString() +
            "\nSkyColourZenith: " +  environmentSettings.skyColourZenith.ToString() +
            "\nSunFocus: " + environmentSettings.sunFocus.ToString() +
            "\nSunIntensity: " + environmentSettings.sunIntensity.ToString());
    }
